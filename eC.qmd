...
I used OpenAI Codex in cursor to generate a script to select 20 tweets randomly from the dataset. If it eases your mind, I have telemetry turned off in cursor. When I have more time, I plan to become a terminal only person. I already have many command line tools (many thanks to your Welcome to the Command Line! guide), I mostly need to get better at using helix or neovim more effectively. I have been using Ghostty as my terminal emulator because it is lightweight and highly configurable.
...
### Prompts for vaderSentiment set up

I git cloned vaderSentiment and then ran this prompt using claude sonnet 4.5 in cursor to make sure all the python packages were installed correctly.
